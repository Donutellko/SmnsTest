package ga.patrick.smns;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import ga.patrick.smns.api.ApiController;
...
public class TestSharedService {
    ...
    public GeocodeResponse geocodeResponseSpbExample;

    public GeocodeResponse geocodeResponseEmptyExample;
    ...
    TestSharedService() throws IOException {
        ...
        geocodeResponseSpbExample = mapper.readValue(
        ...
        geocodeResponseEmptyExample = mapper.readValue(
